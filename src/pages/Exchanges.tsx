...
import { SiBinance, SiCoinbase, SiOkx, SiBitmex, SiBitpanda } from "react-icons/si";
...
const exchanges = [
  ...
  { name: "BitMEX", icon: SiBitmex, color: "text-red-500", volume: "$0.8B", rating: 9.2 },
  { name: "OKX", icon: SiOkx, color: "text-white", volume: "$1.5B", rating: 8.9 },
  { name: "Bitpanda", icon: SiBitpanda, color: "text-teal-400", volume: "$1.2B", rating: 8.7 },
];
